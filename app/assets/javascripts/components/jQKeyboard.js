...
var keyboardLayout = [
  ...
  [ // NORMAL VIEW
    ['Close', '27', 27, 2,  true], ['1', '1', 49, 0, false], ['2', '2', 50, 0, false], [    '3', '3', 51, 0, false],
    [    '4',  '4', 52, 0, false], ['5', '5', 53, 0, false], ['6', '6', 54, 0, false], [    '7', '7', 55, 0, false],
    [    '8',  '8', 56, 0, false], ['9', '9', 57, 0, false], ['0', '0', 48, 0, false], ['BkSpc', '8',  8, 2, false],
    
    [     'q', 'q',  81, 0,  true], ['w', 'w', 87, 0, false], ['e', 'e',  69, 0, false], ['r', 'r',  82, 0, false],
    [     't', 't',  84, 0, false], ['y', 'y', 89, 0, false], ['u', 'u',  85, 0, false], ['i', 'i',  73, 0, false],
    [     'o', 'o',  79, 0, false], ['p', 'p', 80, 0, false], ['[', '[', 219, 0, false], [']', ']', 221, 0, false],
    ['&#92;', '\\', 220, 0, false],
    
    ['a', 'a', 65, 0,  true], ['s', 's',  83, 0, false], [    'd',  'd',  68, 0, false], [    'f',  'f', 70, 0, false],
    ['g', 'g', 71, 0, false], ['h', 'h',  72, 0, false], [    'j',  'j',  74, 0, false], [    'k',  'k', 75, 0, false],
    ['l', 'l', 76, 0, false], [';', ';', 186, 0, false], ['&#39;', '\'', 222, 0, false], ['Enter', '13', 13, 3, false],
    
    ['z', 'z',  90, 0,  true], ['x', 'x',  88, 0, false], ['c', 'c',  67, 0, false], ['v', 'v',  86, 0, false],
    ['b', 'b',  66, 0, false], ['n', 'n',  78, 0, false], ['m', 'm',  77, 0, false], [',', ',', 188, 0, false],
    ['.', '.', 190, 0, false], ['/', '/', 191, 0, false], ['`', '`', 192, 0, false], ['-', '-', 189, 0, false],
    ['=', '=', 187, 0, false],
    
    ['Shift', '16', 16, 3, true], ['Space', '32', 32, 13, false], ['Clear', '46', 46, 3, false], ['Shift', '16', 16, 3, false]
  ], [ // SHIFT VIEW
    ['Close', '27', 27, 2,  true], ['!', '!', 49, 0, false], ['@', '@', 50, 0, false], [    '#', '#', 51, 0, false],
    [    '$',  '$', 52, 0, false], ['%', '%', 53, 0, false], ['^', '^', 54, 0, false], [    '&', '&', 55, 0, false],
    [    '*',  '*', 56, 0, false], ['(', '(', 57, 0, false], [')', ')', 48, 0, false], ['BkSpc', '8',  8, 2, false],
    ...
    ['Z', 'Z',  90, 0,  true], ['X', 'X',  88, 0, false], ['C', 'C',  67, 0, false], ['V', 'V',  86, 0, false],
    ['B', 'B',  66, 0, false], ['N', 'N',  78, 0, false], ['M', 'M',  77, 0, false], ['<', '<', 188, 0, false],
    ['>', '>', 190, 0, false], ['?', '?', 191, 0, false], ['~', '~', 192, 0, false], ['_', '_', 189, 0, false],
    ['+', '+', 187, 0, false],
...
$.fn.initKeypad = function (settings) {
  ...
  $(this).each(function () {
    ...
    if (el.is('input[type="text"]'))
      el.click(function (ev) { activateKeypad(el); });
    else {
      el.click(function (ev) {
        ev.preventDefault();
        activateKeypad(el.data('field'));
      });
    }//if-else
  });
};//$.fn.initKeypad
...
function createKeypad (set) {
  ...
  for (var i = 0; i < layout.length; i++) {
    ...
    $(button).click(function(e){ getKeyPressedValue(e.target); });
...
/*
 * remove keyboard from keypad container
 */
...
function onShiftKeyPressed () {
  ...
  $('button[name="key16"').toggleClass('shift-active', keyboardSet === 1);
}//onShiftKeyPressed
 ...
 * @returns {Boolean}
 */
function onEnterKeyPressed () { return true; }
